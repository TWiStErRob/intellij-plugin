...
![Build](https://github.com/TWiStErRob/intellij-plugin/workflows/Build/badge.svg)
...
- Manually:
  ...
  Download the [latest release](https://github.com/TWiStErRob/intellij-plugin/releases/latest) and install it manually using
